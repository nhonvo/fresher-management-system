...
{
    public record RemoveOneUnitToSyllabusCommand : IRequest<SyllabusDTO>
    {
    ...
    public class RemoveOneUnitToSyllabusHandler : IRequestHandler<RemoveOneUnitToSyllabusCommand, SyllabusDTO>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        public RemoveOneUnitToSyllabusHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<SyllabusDTO> Handle(RemoveOneUnitToSyllabusCommand request, CancellationToken cancellationToken)
        {
