...
namespace Application.Attendances.Queries.GetAttdences
{
    ...
    public record AttendancesQuery(int PageIndex = 0, int PageSize = 10) : IRequest<ApiResult<Pagination<AttendanceDTO>>>;

    public class AttdendenceHandler : IRequestHandler<AttendancesQuery, ApiResult<Pagination<AttendanceDTO>>>
    {
        ...
        public async Task<ApiResult<Pagination<AttendanceDTO>>> Handle(AttendancesQuery request, CancellationToken cancellationToken)
        {
